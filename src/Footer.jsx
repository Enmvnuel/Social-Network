...
function Footer() {
    ...
    return (
        <>
            <footer className="relative z-10 mx-auto max-w-7xl p-6 pt-10 pb-12 text-zinc-400">
                <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <div className="text-xs text-zinc-500 max-w-full md:max-w-[40%] md:text-right">
                        ...
                        <div className="mt-2 flex gap-4 justify-start md:justify-end">
                            ...
                            {/* gradiente movido fuera del footer */}
                        </div>
                    </div>
                </div>
            </footer>

            {/* Gradiente fijo en el pie de la página — ajustar altura cambiando h-48 */}
            <img
                className="fixed left-0 bottom-0 w-full object-cover pointer-events-none -z-1"
